public class TrieNode
{
    ...
    {
        Children = new Dictionary<char, TrieNode>(); // Initializes a new Dictionary(Children of the current node in trie) where the keys are characters (char) and the values are TrieNode objects. 
        IsEndOfWord = false; // This property is typically used to mark the end of a word in a trie. When you insert a word into the trie, you would set IsEndOfWord to true for the last character of the word.
...
public class Trie
{
    ...
    {
        // Initializes a variable current to point to the root of the Trie. The current variable will be used to traverse the Trie.
        ...
        if (current.IsEndOfWord) // If the current node is already the end of a word(meaning that the word is already in Trie), return false.
        {
            return false; // Returns false to indicate that the insertion was not successful.
        }
        // Set the IsEndOfWord property of the current node to true to indicate that the current node is the end of a word.
